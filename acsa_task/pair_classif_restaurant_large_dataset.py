...
def run_onestep_ft():
    ...
    utils.create_fasttext_input_files("restaurant_large", "valid", "ft_onestep_pair_classif", my_data.X_val_full,
                                      my_data.y_val_full)
    utils.create_fasttext_input_files("restaurant_large", "train", "ft_onestep_pair_classif", my_data.X_train_full,
                                      my_data.y_train_full)

    y_pred_labels, y_pred_probs = ft_classification_multilabel("restaurant_large",
                                                               my_data.X_test_full,
...
def run_twostep_ft():
    ...
    utils.create_fasttext_input_files("restaurant_large", "valid", "ft_twotep_pair_classif_categ",
                                      my_data.X_val_full,
                                      y_val_categories)
    utils.create_fasttext_input_files("restaurant_large", "train", "ft_twotep_pair_classif_categ",
                                      my_data.X_train_full,
                                      y_train_categories)

    y_pred_categories, y_pred_probs = ft_classification_multilabel("restaurant_large",
                                                                   my_data.X_test_full,
    ...
    utils.create_fasttext_input_files("restaurant_large", "valid", "ft_twotep_pair_classif_polar", X_val_polarities,
                                      y_val_polarities)
    utils.create_fasttext_input_files("restaurant_large", "train", "ft_twotep_pair_classif_polar", X_train_polarities,
                                      y_train_polarities)
    X_test_polarities = utils.create_as_input_x(my_data.X_test_full, y_pred_categories)

    y_pred_polarities, y_pred_probs = ft_classification_onelabel("restaurant_large",
                                                                 X_test_polarities,
